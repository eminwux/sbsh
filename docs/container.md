...
```bash
docker pull docker.io/eminwux/sbsh:v0.4.0-linux-arm64
```
...
```bash
# AMD64
docker pull eminwux/sbsh:v0.4.0-linux-amd64

# ARM64
docker pull eminwux/sbsh:v0.4.0-linux-arm64
```
...
```dockerfile
FROM docker.io/eminwux/sbsh:v0.4.0-linux-amd64
CMD ["/bin/sbsh"]
```
...
services:
  sbsh:
    image: docker.io/eminwux/sbsh:v0.4.0-linux-amd64
    container_name: sbsh
    volumes:
      - ~/.sbsh:/root/.sbsh
      - ./workspace:/workspace
...
- Pull the correct architecture image:
  - AMD64: `docker.io/eminwux/sbsh:v0.4.0-linux-amd64`
  - ARM64: `docker.io/eminwux/sbsh:v0.4.0-linux-arm64`
...
2. **Version Pinning**: Always pin to specific version tags (e.g., `v0.4.0-linux-amd64`) instead of `latest`
