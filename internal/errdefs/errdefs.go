...
var (
	...
	ErrAttach                   = errors.New("error attaching client")
	ErrClientMode               = errors.New("error client mode not implemented")
	...
	ErrCreateClientDir          = errors.New("failed to create client directory")
	...
	ErrNoClientIdentifier       = errors.New(
		"no client identifier provided; client name, ID, or socket must be specified",
	)
