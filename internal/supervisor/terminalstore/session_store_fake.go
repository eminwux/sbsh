...
type Test struct {
	...
	LastAdded        *api.SupervisedTerminal
	LastGetID        api.ID
	...
	AddFunc        func(s *api.SupervisedTerminal) error
	GetFunc        func(id api.ID) (*api.SupervisedTerminal, bool)
...
func NewTerminalStoreTest() *Test {
	return &Test{
		...
		GetFunc: func(id api.ID) (*api.SupervisedTerminal, bool) {
			...
			return &api.SupervisedTerminal{}, true
		},
		ListLiveFunc: func() []api.ID {
...
func (t *Test) Add(s *api.SupervisedTerminal) error {
	t.LastAdded = s
	if t.AddFunc != nil {
		return t.AddFunc(s)
	}
...
func (t *Test) Get(id api.ID) (*api.SupervisedTerminal, bool) {
	t.LastGetID = id
	if t.GetFunc != nil {
		return t.GetFunc(id)
	}
